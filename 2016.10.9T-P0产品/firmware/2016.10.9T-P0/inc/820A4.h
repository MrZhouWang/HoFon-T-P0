...
#define LED_OK_ON	(p_led_ok    = LED_PWR_ON)
#define LED_OK_OFF	(p_led_ok    = LED_PWR_OFF)

// 数码管共阳极
sbit digital_led1_port	= P0^3 ;	// 第1位数码管的电源IO
...
// 蜂鸣器
sbit p_bell = P0^2;		// 蜂鸣器控制，1关

#define BELL_PWR_ON	0 	// 蜂鸣器控制 开状态
#define BELL_PWR_OFF	1 	// 蜂鸣器控制 关状态

#define BELL_ON		(p_bell = BELL_PWR_ON)
#define BELL_OFF	(p_bell = BELL_PWR_OFF)
...
#define LED_UARTPWR_ON	0 	// UART_LED电源开关状态
#define LED_UARTPWR_OFF	1 	// UART_LED电源开关状态
