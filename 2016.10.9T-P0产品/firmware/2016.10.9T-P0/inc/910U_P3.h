...
sbit p_led_red      = P2^7;				//	交换  p_led_red 与	p_led_green IO口	20151210
sbit p_led_green    = P3^7;
...
// 数码管共阳极
sbit digital_led1_port	= P0^3 ;	// 第1位数码管的电源IO	 添加芯片型号的条件编译	 20151209
sbit digital_led2_port	= P1^4 ;	// 第2位数码管的电源IO
sbit digital_led3_port	= P1^3 ;	// 第3位数码管的电源IO
#if	 (MCUTYPE == STC12C5616AD)
sbit digital_led4_port	=P1^4 ;     // 第1位数码管的电源IO	百位
sbit digital_led5_port	=P1^3 ;     // 第2位数码管的电源IO	 十位
sbit digital_led6_port	=P0^3 ;     // 第3位数码管的电源IO	 个位
#elif(MCUTYPE == STC15W1K16S)
sbit digital_led4_port	= P1^2 ;	// 第4位数码管的电源IO	百位
sbit digital_led5_port	= P1^1 ;	// 第5位数码管的电源IO	十位
sbit digital_led6_port	= P1^0 ;	// 第6位数码管的电源IO	个位
#endif
...
#else
sbit KEY_SUB	  = P3^5;
sbit KEY_CFG      = P3^4;      //P2^4;		20151016更改
sbit KEY_SHT      = P2^4;      //P3^4;	    20151016更改
sbit KEY_OK  	  = P3^3;
#endif
