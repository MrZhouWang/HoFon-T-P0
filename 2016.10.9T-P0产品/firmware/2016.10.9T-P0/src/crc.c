...
INT16U CRC16 ( INT8U xdata * puchMsg, INT8U usDataLen ) 
{ 
    register INT8U  uchCRCHi = 0xFF ;  	// CRC  的高字节初始化
    register INT8U  uchCRCLo = 0xFF ;  	// CRC  的低字节初始化
    register INT16U uIndex;  			// CRC 查询表索引     
